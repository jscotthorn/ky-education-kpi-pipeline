...
- `restraint_rate` - Rate of physical restraint incidents
- `out_of_school_suspension_rate` - Rate of out-of-school suspensions
- `arrest_rate` - Rate of arrests on school property
- `in_school_suspension_rate` - Rate of in-school suspensions
- `expulsion_rate` - Rate of student expulsions
- `corporal_punishment_rate` - Rate of corporal punishment incidents
- `seclusion_rate` - Rate of seclusion incidents
...
- `climate_index_score` - School climate composite index score
- `safety_index_score` - School safety composite index score

## Kentucky Summative Assessment
**Source**: `etl/kentucky_summative_assessment.py`
- `ksa_performance_level_{subject}_{grade}` - Performance level percentages by subject and grade
- `ksa_content_index_{subject}_{grade}` - Content mastery index scores by subject and grade
